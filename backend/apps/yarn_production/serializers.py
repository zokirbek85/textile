...
class YarnBatchCreateSerializer(serializers.Serializer):
    ...
    fiber_source_warehouse_id = serializers.UUIDField()
    yarn_target_warehouse_id = serializers.UUIDField()
...
class CompleteYarnBatchSerializer(serializers.Serializer):
    yarn_output_kg = serializers.DecimalField(max_digits=14, decimal_places=3, min_value="0.001")
    waste_output_kg = serializers.DecimalField(max_digits=14, decimal_places=3, default=0, min_value="0")
    efficiency_pct = serializers.DecimalField(max_digits=6, decimal_places=2, default=0, min_value="0")
